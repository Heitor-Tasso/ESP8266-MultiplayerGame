...
extern unsigned int players_life[num_players];
extern float players_pos[num_players][2];
extern String players_host[num_players];
extern unsigned int players_port[num_players];
extern unsigned int try_connect_player[num_players];
extern unsigned int index_np;
